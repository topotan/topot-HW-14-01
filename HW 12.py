...
def write_quotes_in_csv(file, dictionaries, sort_func):

    author_dicts = sorted(dictionaries, key=sort_func)
...
write_quotes_in_csv("csv_authors_hw12.csv", get_quotes(5), sort_by_name)
